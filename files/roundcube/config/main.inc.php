...
$rcmail_config['default_host'] = 'box';
...
$rcmail_config['support_url'] = 'http://enigmabox.net/kontakt/';
...
$rcmail_config['des_key'] = 'AkTFeF3AT5etSZ6YB6+3h0jv';
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %t = domain.tld
$rcmail_config['username_domain'] = 'box';
...
$rcmail_config['product_name'] = 'Enigmabox Webmail';
